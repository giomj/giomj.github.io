...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ei,depthTest:!1,depthWrite:!1})}function cu(){return new Ri({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:mc(),fragmentShader:`
		...
		`,blending:ei,depthTest:!1,depthWrite:!1})}function lu(){return new Ri({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mc(),fragmentShader:`
