...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function gu(){return new Di({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:bc(),fragmentShader:`
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function _u(){return new Di({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bc(),fragmentShader:`
