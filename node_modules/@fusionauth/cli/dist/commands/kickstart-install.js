...
function createKickstart(kickstartPath, answers, newDir) {
            ...
            inquirer.prompt([
                ...
                setTimeout(() => {
                    ...
                    if (!fs.existsSync(directory))
                        throw (chalk.red(`Something went wrong. ${directory} does not exists.`));
...
//# sourceMappingURL=kickstart-install.js.map