...
const skipLicenseCheckOption = new Option('--skip-license-check', 'Skip checking license activation (for community plan users)').default(false);
const action = function ({ key: apiKey, host, skipLicenseCheck }) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            try {
                ...
                const searchAppsResponse = yield fusionAuthClient.searchApplications({
                    search: {
                        name: 'FusionAuth'
                    }
                });
                if (!searchAppsResponse.wasSuccessful() || !searchAppsResponse.response.applications || searchAppsResponse.response.applications.length === 0) {
                    ...
                    if (!fusionAuthApp.id) {
                        ...
                        const searchResponse = yield fusionAuthClient.searchUsersByQuery({
                            search: {
            ...
            try {
                ...
                // Create test user
                const createUserResponse = yield fusionAuthClient.createUser(null, {
                    user: {
                        email: testEmail,
                ...
                if (!createUserResponse.wasSuccessful()) {
                ...
                else if (!((_a = createUserResponse.response.user) === null || _a === void 0 ? void 0 : _a.id)) {
                    results.push({
                        passed: false,
                    ...
                    if (!searchAppsResponse.wasSuccessful() || !searchAppsResponse.response.applications || searchAppsResponse.response.applications.length === 0) {
                        ...
                        allPassed = false;
                        // Clean up
                        yield fusionAuthClient.deleteUser(userId);
                    }
                    else {
                        const fusionAuthApp = searchAppsResponse.response.applications[0];
                        if (!fusionAuthApp.id) {
                            ...
                            const registrationResponse = yield fusionAuthClient.register(userId, {
                                registration: {
            ...
            try {
                const tenantResponse = yield fusionAuthClient.retrieveTenants();
                if (!tenantResponse.wasSuccessful()) {
                    ...
                    for (const tenant of tenants) {
                        const emailHost = (_b = tenant.emailConfiguration) === null || _b === void 0 ? void 0 : _b.host;
            ...
            if (!skipLicenseCheck) {
                ...
                try {
                    const statusResponse = yield fusionAuthClient.retrieveReactorStatus();
                    if (!statusResponse.wasSuccessful()) {
                        ...
                        if (status === null || status === void 0 ? void 0 : status.licensed) {
                            results.push({
                                passed: true,
...
export const checkCommonConfig = new Command('check:common-config')
    ...
    .action(action);
//# sourceMappingURL=check-common-config.js.map