...
const action = function ({ numberOfFiles, countPerFile, applicationId, groupId, tmpDir, filePrefix }) {
...
export const importGenerate = new Command('import:generate')
    ...
    .action(action);
function generateData(numObjects, appId, groupId, startNumber) {
    const data = [];
...
//# sourceMappingURL=import-generate.js.map